                            ...
                            {s.legal && (
                                <div className="onboarding-legal-list">
                                    ...
                                    <div className="ai-meal-scanning">
                                        ...
                                        <p>All AI-powered nutrition estimates — text or image-based — are processed by Google's Gemini API using your personal API key (set in **Settings**). Results may differ significantly from actual product values.</p>

                                        <p>By using this feature, you agree to <a href="https://healthsync.itsmarian.dev/legal/ai-guidelines" target="_blank" rel="noopener"><strong>HealthSync&apos;s AI Guidelines</strong></a> and to use it at your own risk and verify any nutrition data against trusted sources before relying on it.</p>
                                        <p>No data or image is processed locally — every call goes directly to Google's Gemini API with your personal key stored in the browser.</p><br/>                                        <p>API usage may generate costs based on Google&apos;s current pricing model. HealthSync does not monitor, cap, reimburse, or assume responsibility for any API charges incurred.</p>

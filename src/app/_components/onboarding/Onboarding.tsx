                            ...
                            {s.legal && (
                                <div className="onboarding-legal-list">
                                    ...
                                    <div className="ai-meal-scanning">
                                        ...
                                        <p>Nutrition estimates from text descriptions are processed locally using Ollama and do not require an API key. Image-based nutrition estimation uses Google's Gemini API with your personal API key. You must provide your own Gemini API key in Settings to use this feature.</p>

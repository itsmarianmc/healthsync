...
/**
 * Animate a header button out (width → 0, opacity → 0) then hide it.
 * Mirrors the original removeHeaderBtn() from script.js / dropsync-integration.js.
 * Works for elements inside .button-box as well as standalone elements.
 */
...
/**
 * Animate a hidden header button back in (width → 50px, opacity → 1).
 * Mirrors the original addHeaderBtn() from script.js / dropsync-integration.js.
 * Works for elements inside .button-box as well as standalone elements.
 */

...
> For an index of all Next.js documentation, see [/docs/pages/llms.txt](https://nextjs.org/docs/pages/llms.txt).
...
For an index of all available documentation, see [/docs/pages/llms.txt](https://nextjs.org/docs/pages/llms.txt)